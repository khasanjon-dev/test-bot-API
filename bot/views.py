...
from .models import User, Science, Block, AnswerScience
from .serializers import ScienceModelSerializer, BlockModelSerializer, UserSerializer, AnswerScienceModelSerializer, \
    GetAnswerSerializer
